...
import { editAjobAction, jobLoadSingleAction, registerAjobAction } from '../redux/actions/jobAction';
...
const EditJobPage = () => {
    ...
    useEffect(() => {
        if (singleJob && !initialValuesLoaded) {
         ...
         setQualification(singleJob.qualification);
         setSalary(singleJob.salary);
         setLocation(singleJob.location);
         setJobMode(singleJob.jobMode);
         setCategory(singleJob.jobType);
         setSkillsRequired(singleJob.skills);  
         setDisclose(singleJob.discloseSalary)
    ...
    const handleSubmit = async (e) => {
      ...
      dispatch(editAjobAction(obj,jobId)); 
      setTitle("");
      setCategory("");
      setLocation("");
      setSkillsRequired([]);
    ...
    return (
        <Wrapper>
            ...
            >
                ...
                <button type='submit' className='gradient'>Submit</button>
