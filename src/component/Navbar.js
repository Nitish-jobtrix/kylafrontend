        ...
        <AppBar position="static" sx={{ bgcolor: palette.primary.main }}>
            <Container >
                ...
                <Toolbar disableGutters>
                    <WorkIcon sx={{ color:"orange", display: { xs: 'none', md: 'flex' }, mr: 1 }} />
                    <Typography
                        variant="h6"
                        noWrap
                        component="a"
                        ...
                        >
...

                            {
                                !companyUserInfo ?
                                    ...
                                    <MenuItem onClick={handleCloseUserMenu}>
                                        <Typography textAlign="center"><Link style={{ textDecoration: "none", color: palette.secondary.main }} to="/jobs/login">Log In</Link></Typography>
                                    </MenuItem> :
