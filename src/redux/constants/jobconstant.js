...
export const EDIT_JOB_FAIL = "DELETE_JOB_FAIL";
export const EDIT_JOB_SUCCESS = "DELETE_JOB_SUCCESS";
export const EDIT_JOB_RESET = "DELETE_JOB_RESET";
export const EDIT_JOB_REQUEST = "DELETE_JOB_REQUEST";
